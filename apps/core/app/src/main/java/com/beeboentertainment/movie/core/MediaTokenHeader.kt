 ...
 * without it. The MediaItem keeps the full URL, so casting still hands the TV a working link.
 *
...
object MediaTokenHeader {
    ...
    private val TOKEN_PATHS = listOf("/file", "/tvfile", "/subtitles/file", "/subtitles/embedded")
